...
export const REPORT_CARDS: ReportCard[] = [
  {
    ...
    items: [
      'Tempo visível, páginas visualizadas e concluídas',
      'Profundidade de leitura e recursos abertos',
      'Vídeo iniciado/concluído, ODA acessada, zoom em imagem',
      'Botão do professor, feedback e ambiente técnico',
      'Saúde da coleta',
    ],
    usage: 'Validar uma sessão e entender uma experiência individual.',
    status: 'available',
  },
  {
    title: 'Relatório consolidado de grupo ou turma',
    items: [
      'Total de participantes e taxa média de conclusão',
      'Tempo visível médio e distribuição de profundidade',
      'Páginas menos concluídas e recursos mais usados',
      'Taxa de abertura de ODA e play/conclusão de vídeo',
      'Feedback médio e problemas técnicos recorrentes',
    ],
    usage: 'Transformar várias sessões individuais em uma leitura coletiva.',
    status: 'available',
  },
  {
