...
import Poster from '@book/components/Poster';
import Chapter from '@book/components/Chapter';
import TeacherButton from '@book/components/TeacherButton';
import Header from '@book/components/Header';
import BookPageTracker from '@analytics-ui/BookPageTracker';
import { chapterQuestions } from '@book/data/questions';
import Pagination from '@book/components/Pagination';
import CaixaTexto from '@book/components/CaixaTexto';
import QuestionRenderer from '@book/components/QuestionRenderer';
import ContinuaProximaPagina from '@book/components/ContinuaProximaPagina';
import CriteriosAvaliacao from '@book/components/CriteriosAvaliacao';
import ChapterFeedback from '@book/components/ChapterFeedback';
import Footer from '@book/components/Footer';
import { useUserAnswers } from '@book/hooks/useUserAnswers';
import { usePagination } from '@book/hooks/usePagination';
import { useScrollPosition } from '@book/hooks/useScrollPosition';
import ScrollPageIndicator from '@book/components/ScrollPageIndicator';
import { TeacherAnswers } from '@book/components/TeacherAnswers';
import ConversaVai from '@book/components/ConversaVai';
import ConversaVem from '@book/components/ConversaVem';
import EscolaDigital from '@book/components/EscolaDigital';
import ParaSaberMais from '@book/components/ParaSaberMais';
import OrganizandoConhecimentos from '@book/components/OrganizandoConhecimentos';
import SaberesAcao from '@book/components/SaberesAcao';
import TestandoIdeias from '@book/components/TestandoIdeias';
import AgoraVoceJaSabe from '@book/components/AgoraVoceJaSabe';
import GameModal from '@book/components/GameModal';
import TrackedImage from '@analytics-ui/TrackedImage';
import OdaSAE26_AI43_HIS_C07_OA1 from '@book/oda/SAE26_AI43_HIS_C07_OA1';
              ...
              <>
                ...
                <div className="mx-auto my-6 flex w-full max-w-[520px] flex-col items-center text-center">
                  ...
                  <TrackedImage
                    ...
                    alt="Gravura de nau de Pedro Álvares Cabral"
                  >
                  <p className="mt-2 text-[10px] text-slate-600" style={{ fontSize: '10px' }}>
