...
export function SessionProvider({
  ...
  const sessionId = useMemo(() => {
    ...
    const statusBeforeRecover = getSessionStatus();
    recoverActiveSessionAfterReload(id);
    if (statusBeforeRecover === 'finished' && getSessionStatus() === 'active') {
...
export function useAnalytics(): AnalyticsContextValue {
  ...
  if (!context) {
    throw new Error('useAnalytics deve ser usado dentro de SessionProvider');
  }
  return context;
}

/** Retorna null fora do SessionProvider (componentes compartilhados). */
