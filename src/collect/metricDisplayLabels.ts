...
export const PAGE_COMPLETION_RATE_LABEL = 'Taxa de conclusão de páginas';

export const READING_DEPTH_LABEL = 'Profundidade de leitura';

export const READING_DEPTH_EXPLANATION =
  'Classificação baseada no tempo visível médio por página visualizada.';
